...
/// functions. Each GherkinDeclarer in the tree corresponds to a group. This tree is
/// tracked by a zone-scoped "current" GherkinDeclarer; the current declarer can be set
/// for a block using [GherkinDeclarer.declare], and it can be accessed using
/// [GherkinDeclarer.current].
class GherkinDeclarer {
  /// The parent declarer, or `null` if this corresponds to the root group.
  final GherkinDeclarer? _parent;
  ...
  static GherkinDeclarer? get current => Zone.current[#test.declarer]
    as GherkinDeclarer?;
  ...
  /// Runs [body] with this declarer as [GherkinDeclarer.current].
  ///
  ...
  void given(String name, dynamic Function(List<dynamic>) body,
    ...
    _addEntry(LocalTest(fullName, metadata, () async {
      var parents = <GherkinDeclarer>[];
      for (GherkinDeclarer? declarer = this;
      declarer != null;
...
/*
  ...
  void group(String name, void Function() body,
    ...
    var declarer = GherkinDeclarer._(
        this,
        fullTestPrefix,
        metadata,
        _platformVariables,
